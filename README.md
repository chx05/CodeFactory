CodeFactory is a C/C++ scriptable framework written in Python for source generation and compile time C/C++ code inspection.
CodeFactory also supports a Python build script for your C/C++ project.
